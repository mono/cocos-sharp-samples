...
namespace AirHockey.Common
{
    public class IntroLayer : CCLayerColor
    {
        ...
        public IntroLayer()
        {
            ...
            _player1ScoreLabel.SetPosition(_screenSize.Width - 60f, _screenSize.Height * 0.5f - 80f);
            _player1ScoreLabel.Rotation = 90;
            AddChild(_player1ScoreLabel);

            _player2ScoreLabel = new CCLabelTtf("0", "MarkerFelt", 22);
            _player2ScoreLabel.SetPosition(_screenSize.Width - 60f, _screenSize.Height * 0.5f + 80f);
        ...
        void playerScore(int player)
        {
            ...
            _player1.SetPosition(_screenSize.Width * 0.5f, _player1.radius * 2);
            _player2.SetPosition(_screenSize.Width * 0.5f, _screenSize.Height - _player1.radius * 2f);
