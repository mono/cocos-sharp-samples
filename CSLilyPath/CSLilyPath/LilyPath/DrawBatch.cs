...
namespace LilyPath
{
    ...
    public class DrawBatch : CCGeometryNode, IDisposable
    {
        ...
        {
            _geometryBuffer[0] = new CCPoint(rect.Left, rect.Top);
            _geometryBuffer[1] = new CCPoint(rect.Right, rect.Top);
            _geometryBuffer[2] = new CCPoint(rect.Right, rect.Bottom);
            _geometryBuffer[3] = new CCPoint(rect.Left, rect.Bottom);
        ...
        public void DrawQuad(Pen pen, CCVector2[] points, int offset, float angle)
        {
            ...
            //    var refTransform = new CCAffineTransform();
                
            //    for (int i = 0; i < 4; i++)
            //        _geometryBuffer[i] = CCVector2.Transform(_geometryBuffer[i] - center, ref refTransform);
            //}
        ...
        {
            _geometryBuffer[0] = new CCVector2(rect.Left, rect.Top);
            _geometryBuffer[1] = new CCVector2(rect.Right, rect.Top);
            _geometryBuffer[2] = new CCVector2(rect.Right, rect.Bottom);
            _geometryBuffer[3] = new CCVector2(rect.Left, rect.Bottom);
        ...
        public void DrawPoint(Pen pen, CCVector2 point)
        {
            ...
            //AddVertex(new CCVector2(point.X - w2, point.Y - w2), pen);
            //AddVertex(new CCVector2(point.X + w2, point.Y - w2), pen);
            //AddVertex(new CCVector2(point.X - w2, point.Y + w2), pen);
            //AddVertex(new CCVector2(point.X + w2, point.Y + w2), pen);
        ...
        public void DrawPrimitivePath(Pen pen, IList<CCVector2> points, int offset, int count, PathType pathType)
        {
            ...
            //    _vertexBuffer[_vertexBufferIndex++] = new VertexPositionColorTexture(new Vector3(pos, 0), pen.Color, CCVector2.Zero);
            //}
        ...
        {
            DrawEllipse(pen, new CCVector2(bound.Center.X, bound.Center.Y), bound.Width / 2f, bound.Height / 2f, 0);
        }
        ...
        {
            DrawEllipse(pen, new CCVector2(bound.Center.X, bound.Center.Y), bound.Width / 2f, bound.Height / 2f, angle);
        }
        ...
        {
            DrawEllipse(pen, new CCVector2(bound.Center.X, bound.Center.Y), bound.Width / 2f, bound.Height / 2f, angle, subdivisions);
        }
        ...
        {
            DrawPrimitiveEllipse(pen, new CCVector2(bound.Center.X, bound.Center.Y), bound.Width / 2f, bound.Height / 2f, 0);
        }
        ...
        {
            DrawPrimitiveEllipse(pen, new CCVector2(bound.Center.X, bound.Center.Y), bound.Width / 2f, bound.Height / 2f, angle);
        }
        ...
        {
            DrawPrimitiveEllipse(pen, new CCVector2(bound.Center.X, bound.Center.Y), bound.Width / 2f, bound.Height / 2f, angle, subdivisions);
        }
        ...
        private void BuildEllipseGeometryBuffer (CCVector2 center, float xRadius, float yRadius, float angle, int subdivisions)
        {
            ...
            //for (int i = 0; i < subdivisions; i++)
            //    _geometryBuffer[i] = CCVector2.Transform(_geometryBuffer[i], transform);
        }
        ...
        {
            FillEllipse(brush, new CCVector2(bound.Center.X, bound.Center.Y), bound.Width / 2f, bound.Height / 2f, 0);
        }
        ...
        {
            FillEllipse(brush, new CCVector2(bound.Center.X, bound.Center.Y), bound.Width / 2f, bound.Height / 2f, angle);
        }
        ...
        {
            FillEllipse(brush, new CCVector2(bound.Center.X, bound.Center.Y), bound.Width / 2f, bound.Height / 2f, angle, subdivisions);
        }
        ...
        public void FillQuad (Brush brush, CCVector2[] points, int offset, float angle)
        {
            ...
            //    for (int i = 0; i < 4; i++)
            //        _geometryBuffer[i] = CCVector2.Transform(_geometryBuffer[i] - center, transform);
            //}
        ...
        private void AddVertex (CCVector2 position, Pen pen)
        {
        ...
        private void AddVertex (CCVector2 position, Color color, Pen pen)
        {
            ...
            //    vertex.TextureCoordinate = new CCVector2(position.X / tex.Width, position.Y / tex.Height);
            //    vertex.TextureCoordinate = CCVector2.Transform(vertex.TextureCoordinate, pen.Brush.Transform);
            //    vertex.Color *= pen.Brush.Alpha;
            //}
            //else {
            //    vertex.TextureCoordinate = new CCVector2(position.X, position.Y);
            //}
        ...
        private void AddVertex (CCVector2 position, Brush brush)
        {
            ...
            //    vertex.TextureCoordinate = new CCVector2(position.X / tex.Width, position.Y / tex.Height);
            //    vertex.TextureCoordinate = CCVector2.Transform(vertex.TextureCoordinate, brush.Transform);
