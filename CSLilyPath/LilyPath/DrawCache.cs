...
namespace LilyPath
{
    ...
    public class DrawCache
    {
        ...
        internal void Render (DrawBatch drawBatch, CCTexture2D defaultTexture)
        {
            foreach (var unit in _units)
                unit.Render(drawBatch, defaultTexture);
        }
    }
    ...
    internal class DrawCacheUnit
    {
        ...
        public DrawCacheUnit (VertexPositionColorTexture[] vertexBuffer, short[] indexBuffer, CCTexture2D texture)
        {
            _texture = texture;
