...
namespace LilyPath
{
    ...
    public class Pen : IDisposable
    {
        ...
        protected internal virtual CCColor4B ColorAt (float widthPosition, float lengthPosition, float length)
        {
            return Brush.Color.ToCCColor4B();
        }
        ...
        internal CCColor4B ColorAt(CCVector2 uv, float lengthScale)
        {
