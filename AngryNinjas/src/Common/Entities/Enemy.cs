        ...
        void CreateEnemy()
        {
            ...
            else if (shapeCreationMethod == CreationMethod.ShapeOfSourceImageButSlightlySmaller)
            {
                ...
                b2Vec2[] vertices = {
					...
					new b2Vec2( (tempSprite.Texture.ContentSizeInPixels.Width / -2 )*.8f / Constants.PTM_RATIO, (tempSprite.Texture.ContentSizeInPixels.Height / -2 )*.8f / Constants.PTM_RATIO), //bottom left corner
					new b2Vec2( (tempSprite.Texture.ContentSizeInPixels.Width / 2 )*.8f / Constants.PTM_RATIO, (tempSprite.Texture.ContentSizeInPixels.Height / -2 )*.8f / Constants.PTM_RATIO), //bottom right corner
					new b2Vec2( (tempSprite.Texture.ContentSizeInPixels.Width / 2 )*.8f / Constants.PTM_RATIO, (tempSprite.Texture.ContentSizeInPixels.Height / 2 )*.8f / Constants.PTM_RATIO) //top right corner
				};
                shape.Set(vertices, num);
            }
