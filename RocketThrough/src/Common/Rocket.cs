	...
	public class Rocket : GameSprite
	{
		...
		public override void Update(float dt)
		{
			...
			else
			{
				...
				CCPoint clockwise = CCPoint.PerpendicularCW(position - _pivot);
		...
		public void select(bool flag)
		{
			if (flag)
			{
				SpriteFrame = CCSpriteFrameCache.SharedSpriteFrameCache["rocket_on.png"];
			}
			else
			{
				SpriteFrame = CCSpriteFrameCache.SharedSpriteFrameCache["rocket.png"];// CCSpriteFrameCache.SharedSpriteFrameCache.SpriteFrameByName("rocket.png");
			}
		}
		...
		public bool collidedWithSides()
		{
			...
			CCSize screenSize = Window.WindowSizeInPixels;
