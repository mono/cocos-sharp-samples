...
namespace RocketThrought.Windows
{
    public class AppDelegate : CCApplication
    {
        ...
        public override bool ApplicationDidFinishLaunching()
        {
            ...
            //                                      preferredHeight,
            //                                      resPolicy);
             CCSize designSize = new CCSize(1024, 768);

            if (CCDrawManager.FrameSize.Height > 320)
            {
                CCSize resourceSize;// = new CCSize(480, 320);
                resourceSize = new CCSize(1024, 768);
                //resourceSize *= 2;
                pDirector.ContentScaleFactor = resourceSize.Height / designSize.Height;
                //pDirector.ContentScaleFactor = designSize.Height / resourceSize.Height;
            }

            CCDrawManager.SetDesignResolutionSize(designSize.Width, designSize.Height, CCResolutionPolicy.NoBorder);
            // turn on display FPS
